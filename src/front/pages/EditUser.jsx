        ...
        try {
            ...
            if (response.ok) {
                ...
                if (data.audit) {
                    ...
                    console.log(`Realizado por (Admin): ${data.audit.modified_by.name} (ID: ${data.audit.modified_by.id})`);
                    console.log(`Usuario modificado: ${data.audit.user_modified.name} (ID: ${data.audit.user_modified.id})`);
                    console.log(`Fecha y hora: ${new Date(data.audit.date_time).toLocaleString()}`);
                    console.log("Detalle de los cambios:");
